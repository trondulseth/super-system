...
- **Next handoff:** Merge Batch 2 to main, sync living specs if needed, then start Batch 3 overlay components under `expand-react-component-library` with keyboard, focus-trap, and portal behavior before publishing a new beta tag.
